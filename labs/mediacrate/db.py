...
INSERT OR IGNORE INTO users VALUES
  (1,'admin','a82b7eef403a975673f6d50f1d35446e','admin@mediacrate.local','MediaCrate Admin','admin',1,'mc-admin-7f2e9b1a','Platform operations.'),
  (2,'demo','fe01ce2a7fbac8fafaed7c982a04e229','demo@mediacrate.local','Demo Viewer','user',0,'mc-user-demo01','Just here to watch.'),
  (3,'nova.lee','a27cf0aae011db129351209b24d23bb5','nova@mediacrate.local','Nova Lee','user',0,'mc-user-1a2b3c','Gaming + vlogs. Streaming most nights.'),
  (4,'theo.park','321cdb03a667fbf008d2e8596410d801','theo@mediacrate.local','Theo Park','user',0,'mc-user-4d5e6f','Cooking channel.'),
  (5,'mira.santos','87eead70aa653391b351c8588b6a837c','mira@mediacrate.local','Mira Santos','user',0,'mc-user-7g8h9i','Music covers and live sets.'),
  (6,'kenji.ito','c52172481d91be3a612ec2e7814d3fdf','kenji@mediacrate.local','Kenji Ito','user',0,'mc-user-1j2k3l','Tech reviews.'),
  (7,'priya.rao','fafda9c4622b8323c1f33a7b9eb975a2','priya@mediacrate.local','Priya Rao','user',0,'mc-user-4m5n6o','Travel + food.'),
  (8,'owen.fitz','9f14c57d3d12b1b4fc108a9b1bd1d04f','owen@mediacrate.local','Owen Fitzgerald','user',0,'mc-user-7p8q9r','Fitness streams.');

INSERT OR IGNORE INTO channels VALUES
  (1,1,'MediaCrate Ops','Official platform announcements and operations.',1200,1,''),
  (2,3,'Nova Plays','Gaming highlights and full VODs.',48200,1,''),
  (3,4,'Theo Cooks','Weeknight recipes and pantry tips.',9100,0,''),
  ...
  (4,5,'Mira Sessions','Music covers, acoustic sets, and live shows.',15300,0,'Tier 2 perk unlock code for this month''s livestream: FLAG{mc_idor_subscriber_content_exposed}'),
  (5,6,'Kenji Reviews','Hands-on tech reviews and teardown.',6700,0,''),
  (6,7,'Priya Roams','Travel vlogs and street food crawls.',22800,1,''),
  (7,8,'Fitz Fitness','Daily workout streams.',3400,0,''),
  (8,2,'Demo Channel','Demo account test uploads.',5,0,'');
