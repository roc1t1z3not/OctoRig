...
CHALLENGES: list[dict] = [
    ...
    dict(challenge_id="my1a", tier=1, title="First Blood",
         ...
         technique="Error-based", endpoint="/challenges/my1/users?id=1",
    ...
    dict(challenge_id="my1b", tier=1, title="Secret Stash",
         ...
         technique="UNION-based", endpoint="/challenges/my1/secrets?id=1",
    ...
    dict(challenge_id="my1c", tier=1, title="Double Trouble",
         ...
         technique="Error-based", endpoint="/challenges/my1/notes?author=admin",
    ...
    dict(challenge_id="my2a", tier=2, title="Invisible Gate",
         ...
         technique="Boolean-blind", endpoint="/challenges/my2/lookup?name=admin",
    ...
    dict(challenge_id="my2b", tier=2, title="Login Wall",
         ...
         technique="Error/Boolean", endpoint="/challenges/my2/login",
    ...
    dict(challenge_id="my2c", tier=2, title="OR Gate",
         ...
         technique="Boolean-blind (OR)", endpoint="/challenges/my2/lookup?name=nobody",
    ...
    dict(challenge_id="my2d", tier=2, title="Second Sight",
         ...
         technique="Two-step", endpoint="/challenges/my2/search?user=admin",
    ...
    dict(challenge_id="my3b", tier=3, title="Hidden Corridor",
         ...
         technique="Path-param", endpoint="/challenges/my3/item/1",
    ...
    dict(challenge_id="my3c", tier=3, title="Triple Threat",
         ...
         technique="UNION (3 cols)", endpoint="/challenges/my3/products?id=1",
    ...
    dict(challenge_id="my3d", tier=3, title="High Five",
         ...
         technique="UNION (5 cols)", endpoint="/challenges/my3/catalog?id=1",
    ...
    dict(challenge_id="my3e", tier=3, title="Paren Trap",
         ...
         technique="Boolean-blind (paren)", endpoint="/challenges/my3/account?username=jsmith",
    ...
    dict(challenge_id="my4a", tier=4, title="The Filter",
         ...
         technique="WAF bypass", endpoint="/challenges/my4/filtered?id=1",
    ...
    dict(challenge_id="my4b", tier=4, title="API Whisperer",
         ...
         technique="JSON body", endpoint="/challenges/my4/api/user",
    ...
    dict(challenge_id="my4c", tier=4, title="Stack Attack",
         ...
         technique="Stacked", endpoint="/challenges/my4/stacked?id=1",
    ...
    dict(challenge_id="my4d", tier=4, title="Tick Tock",
         ...
         technique="Time-blind", endpoint="/challenges/my4/timer?val=x",
    ...
    dict(challenge_id="my4e", tier=4, title="Cookie Monster",
         ...
         technique="Cookie injection", endpoint="/challenges/my4/profile",
    ...
    dict(challenge_id="my5a", tier=5, title="Full Chain",
         ...
         technique="EBTUS", endpoint="/challenges/my5/report?id=1",
    ...
    dict(challenge_id="my1d", tier=1, title="What's Your Version",
         ...
         technique="UNION / @@version", endpoint="/challenges/my1/users?id=1",
    ...
    dict(challenge_id="my4g", tier=4, title="No Space No Problem",
         ...
         technique="WAF bypass (/**/ spaces)", endpoint="/challenges/my4/nospace?id=1",
    ...
    dict(challenge_id="my4h", tier=4, title="Hex Spell",
         ...
         technique="Hex / CHAR() bypass", endpoint="/challenges/my4/hexstore?id=1",
    ...
    dict(challenge_id="my4i", tier=4, title="Burning Cycles",
         ...
         technique="BENCHMARK time-blind", endpoint="/challenges/my4/benchmark?val=x",
    ...
    dict(challenge_id="my5c", tier=5, title="Broken Words",
         ...
         technique="Keyword doubling / CONCAT obfuscation", endpoint="/challenges/my5/vault?id=1",
    ...
    dict(challenge_id="sq2i", tier=11, title="Lite Whisperer",
         ...
         ui_endpoint="/challenges/sq2i/ui"),
]
